  ...
  _createClass(CartesianAxis, [{
    ...
    value: function renderTicks(ticks) {
      ...
      var items = finalTicks.map(function (entry, i) {
        ...
        }, (0, _types.adaptEventsOfChild)(_this.props, entry, i)), tickLine && _react["default"].createElement("line", _extends({}, tickLineProps, lineCoord, {
    ...
    value: function getTicks(props) {
      ...
      if ((0, _DataUtils.isNumber)(interval) || _Global["default"].isSsr) {
